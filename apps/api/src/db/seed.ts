...
const additionalExercises: ExerciseSeed[] = [
  ...
  ["TRX Row", "upper pull", ["upper back", "lats"], ["TRX"]],
  ["TRX W", "upper pull", ["rear delts", "upper back"], ["TRX"]],
  ["TRX Fallout", "core", ["abdominals", "lats"], ["TRX"]],
  ["TRX Push-Up", "upper push", ["chest", "triceps"], ["TRX"]],
  ["Sled Push", "hyrox", ["quadriceps", "glutes", "calves"], ["sled"]],
  ["Sled Pull", "hyrox", ["hamstrings", "glutes", "back"], ["sled"]],
  ["Battle Rope Wave", "conditioning", ["shoulders", "core"], ["battle ropes"]],
  ["Battle Rope Slam", "conditioning", ["shoulders", "core", "lats"], ["battle ropes"]],
  ["Treadmill Run", "conditioning", ["cardiovascular"], ["treadmill"]],
  ["Outdoor Run", "conditioning", ["cardiovascular"], ["outdoor running routes"]],
  ["Incline Treadmill Walk", "conditioning", ["cardiovascular", "calves"], ["treadmill"]],
  ["Rower", "conditioning", ["cardiovascular", "back", "legs"], ["rower"]],
  ["Jump Rope", "conditioning", ["calves", "cardiovascular"], ["jump rope"]],
  ["Mountain Climber", "conditioning", ["core", "hip flexors"], ["bodyweight"]],
  ["Burpee No Push-Up", "conditioning", ["full body"], ["bodyweight"]],
  ["V-Up", "core", ["abdominals", "hip flexors"], ["bodyweight"]],
  ["Side Plank", "core", ["obliques"], ["bodyweight"]],
  ["Plank", "core", ["abdominals"], ["bodyweight"]],
  ["DB Thruster", "hyrox", ["quadriceps", "glutes", "shoulders"], ["dumbbells"]],
  ["Dumbbell Renegade Row", "upper pull", ["back", "core"], ["dumbbells"]],
  ["Suitcase Carry", "hyrox", ["grip", "core"], ["dumbbells"]],
  ["Front Rack Carry", "hyrox", ["core", "shoulders"], ["dumbbells"]],
  ["Walking Farmer Lunge", "lower unilateral", ["quadriceps", "glutes", "grip"], ["dumbbells"]],
  ["Cable Lat Pulldown", "upper pull", ["lats", "biceps"], ["cable system"]],
  ["Cable Wood Chop", "core", ["obliques", "abdominals"], ["cable system"]],
  ["Cable Lateral Raise", "upper accessory", ["shoulders"], ["cable system"]],
  ["Cable Curl", "upper accessory", ["biceps"], ["cable system"]],
  ["Dumbbell Fly", "upper accessory", ["chest"], ["dumbbells", "bench"]],
  ["Close-Grip Push-Up", "upper push", ["triceps", "chest"], ["bodyweight"]],
  ["Low Box Jump", "power", ["quadriceps", "glutes"], ["box"]],
  ["Fast Step-Up", "power", ["quadriceps", "glutes"], ["box"]],
  ["Body Saw", "core", ["abdominals"], ["TRX"]],
  ["Dead Bug", "core", ["abdominals"], ["bodyweight"]],
  ["Captain's Chair Knee Raise", "core", ["abdominals", "hip flexors"], ["pull-up bar"]]
